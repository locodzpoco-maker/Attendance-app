...
import { Clock, Plus, Edit2, Check, ShieldCheck, Sun, Moon } from 'lucide-react';
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          <div>
            ...
            <p className="text-xs text-slate-500 mt-0.5">
              PRD Sections 11–13: Work rules, breaks, cross-midnight handling, and 15-minute overtime thresholds.
            </p>
          </div>
